    ...
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-10 text-center">
        ...
        <p className="mt-3 max-w-2xl mx-auto text-lg text-stone-300">
          ابحث عن المدرس المثالي لك من بين مجموعتنا المتنوعة   .
        </p>
      </div>
      ...
      <div className="mb-12 max-w-2xl mx-auto">
        <div className="relative">
          <input
            ...
            className="w-full p-4 pr-12 text-lg text-stone-300 border border-gray-300 rounded-full shadow-sm focus:outline-none"
            dir="rtl"
          />
